...
} else (Number.isInteger(numero) && numero > 0);{
...
function obtenerSaludo(nombre) {
  ...
  // Tu código:
  var combinarSaludo = "Hola" + " " + nombre + "!"
  return combinarSaludo;
}
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var combinarSimbolo = str + "!"
  return combinarSimbolo;
}
...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
array = array.map((numero) => numero +1)
return array
}
